    ...
    <div className="bg-amber-500 h-[2px] w-0 group-hover:w-[200px] transition-all duration-500"></div>
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              <div class="bg-[#800080] w-full h-auto py-2 flex lg:items-start items-center lg:justify-start  justify-center gap-4 flex-wrap">
      ...
      <Link to='https://www.instagram.com/holisticcareservicesliverpool?igsh=MWZjaTR2NWxyZTlkcA=='>
